'''
This module generate public-private key pair used algorithm is RSA.
'''

## {{{ http://code.activestate.com/recipes/577737/ (r1)
...
if __name__ == '__main__':
    ...
    print format("%s", h)
    print(repr(p))
## end of http://code.activestate.com/recipes/577737/ }}}
